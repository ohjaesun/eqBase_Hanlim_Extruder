...
using static EQ.Core.Sequence.seq12Step;
namespace EQ.Core.Sequence
{
    public enum seq12_Sig // 이름 포맷 꼭 지켜야 함 (이름 + _Sig)  => XXX_Sig
    {
        TrayReady,      // 트레이 준비 완료 신호
        WorkComplete    // 작업 완료 신호
    }
    public enum seq12Step
    {
        Start,
        Step2,
        Step3,
    ...
    public class Seq12 : AbstractSeqBase<seq12Step>
    {

        public Seq12(SEQ seqManager, ACT actManager) : base(seqManager, actManager)
        {
            InitSignals<seq12_Sig>();
        }
