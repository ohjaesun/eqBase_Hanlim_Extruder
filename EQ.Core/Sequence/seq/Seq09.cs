...
using static EQ.Core.Sequence.seq09Step;
namespace EQ.Core.Sequence
{
    public enum seq09_Sig // 이름 포맷 꼭 지켜야 함 (이름 + _Sig)  => XXX_Sig
    {
        TrayReady,      // 트레이 준비 완료 신호
        WorkComplete    // 작업 완료 신호
    }
    public enum seq09Step
    {
        Start,
        Step2,
        Step3,
    ...
    public class Seq09 : AbstractSeqBase<seq09Step>
    {

        public Seq09(SEQ seqManager, ACT actManager) : base(seqManager, actManager)
        {
            InitSignals<seq09_Sig>();
        }
