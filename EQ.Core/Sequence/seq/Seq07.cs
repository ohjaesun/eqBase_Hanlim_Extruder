...
using static EQ.Core.Sequence.seq07Step;
namespace EQ.Core.Sequence
{
    public enum seq07_Sig // 이름 포맷 꼭 지켜야 함 (이름 + _Sig)  => XXX_Sig
    {
        TrayReady,      // 트레이 준비 완료 신호
        WorkComplete    // 작업 완료 신호
    }
    public enum seq07Step
    {
        Start,
        Step2,
        Step3,
    ...
    public class Seq07 : AbstractSeqBase<seq07Step>
    {

        public Seq07(SEQ seqManager, ACT actManager) : base(seqManager, actManager)
        {
            InitSignals<seq07_Sig>();
        }
